...
parser.add_argument('--dataset', default='imagenet20', type=str, choices=['imagenet1k', 'cifar10', 'cifar100'], help='dataset for training')
parser.add_argument('--num_classes', default=20, type=int, help='number of classes for classification')
...
parser.add_argument('--batch_size', default=64, type=int, metavar='BS', help='mini-batch size (default: 256)')
