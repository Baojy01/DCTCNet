...
parser.add_argument('--arch', default='MultiNet50', type=str, choices=model_names, metavar='ARCH', help='model architecture (default: resnet50)')
...
parser.add_argument('--ratio', default=0.25, type=float, help='The ratio of APSeDCTConv channels')
